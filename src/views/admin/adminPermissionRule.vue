    ...
    <el-dialog
      ...
      <el-form :model="formData" :rules="formRules" ref="dataForm">
        ...
        <el-form-item label="排序" prop="sort">
          <el-input type="" v-model.number="formData.sort" auto-complete="off"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import {
  authAdminPermissionRuleList,
  authAdminPermissionRuleSave,
  authAdminPermissionRuleDelete
} from "../../api/auth/authAdminPermissionRule.js";
...
export default {
  ...
  methods: {
      ...
      return (
          <span
            ...
            <el-button style="font-size: 12px;" type="text"
                       on-click={() => this.handleForm(node, data, 'add')}>添加子菜单</el-button>
            <el-button style="font-size: 12px;" type="text"
                       on-click={() => this.handleForm(node, data, 'edit')}>编辑</el-button>
    ...
    getList() {
      this.loading = true;
      authAdminPermissionRuleList(this.query)
          .then(response => {
            this.loading = false;
            if (response.code) {
    ...
    formSubmit() {
      this.$refs["dataForm"].validate(valid => {
        if (valid) {
          ...
          authAdminPermissionRuleSave(data, this.formName)
              .then(response => {
        ...
        this.$confirm("确认删除该记录吗?", "提示", {
          type: "warning"
            ...
            .then(() => {
              ...
              let para = {id: data.id};
              authAdminPermissionRuleDelete(para)
                  .then(response => {
