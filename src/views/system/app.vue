    ...
    <el-dialog
      ...
      <el-dialog
        ...
        <el-form :model="collectionFormData" :rules="collectionFormRules" ref="dataCollectionForm">
          ...
          <el-form-item label="归集私钥（自动归集时需要，修改后需要重新启动，去掉0x为空表示不修改）" prop="collection_private_key">
            <el-input v-model="collectionFormData.collection_private_key" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="提现的私钥（自动提现时需要，修改后需要重新启动，去掉0x为空表示不修改）" prop="withdraw_private_key">
